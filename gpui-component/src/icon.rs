...
impl IconNamed for IconName {
    fn path(self) -> SharedString {
        match self {
            ...
            Self::Alpha => "icons/math/alpha.svg",
            Self::AlphaUpper => "icons/math/alpha-upper.svg",
            ...
            Self::Beta => "icons/math/beta.svg",
            Self::BetaUpper => "icons/math/beta-upper.svg",
            Self::Bold => "icons/editor/bold.svg",
            Self::BookOpen => "icons/book-open.svg",
            Self::Bot => "icons/bot.svg",
            Self::Bug => "icons/ui/bug.svg",
            ...
            Self::Close => "icons/window/window-close.svg",
            Self::Code => "icons/editor/code.svg",
            ...
            Self::Fraction => "icons/math/fraction.svg",
            Self::Frame => "icons/frame.svg",
            Self::Function => "icons/ui/function.svg",
            Self::GalleryVerticalEnd => "icons/gallery-vertical-end.svg",
            Self::Gamma => "icons/math/gamma.svg",
            Self::GammaUpper => "icons/math/gamma-upper.svg",
            Self::GitHub => "icons/github.svg",
            Self::Globe => "icons/globe.svg",
            Self::Heading => "icons/editor/heading.svg",
            Self::Heart => "icons/heart.svg",
            Self::HeartOff => "icons/heart-off.svg",
            Self::Home => "icons/ui/home.svg",
            Self::Inbox => "icons/inbox.svg",
            Self::Info => "icons/info.svg",
            Self::Inspector => "icons/inspector.svg",
            Self::Integral => "icons/math/integral.svg",
            Self::Italic => "icons/editor/italic.svg",
            Self::LayoutDashboard => "icons/layout-dashboard.svg",
            Self::List => "icons/editor/list.svg",
            Self::Loader => "icons/loader.svg",
            Self::LoaderCircle => "icons/loader-circle.svg",
            Self::Map => "icons/map.svg",
            Self::Matrix => "icons/math/matrix.svg",
            Self::Maximize => "icons/maximize.svg",
            Self::Menu => "icons/menu.svg",
            Self::Minimize => "icons/minimize.svg",
            Self::Minus => "icons/editor/minus.svg",
            Self::Moon => "icons/moon.svg",
            Self::Omega => "icons/math/omega.svg",
            Self::OmegaUpper => "icons/math/omega-upper.svg",
            ...
            Self::Pi => "icons/math/pi.svg",
            Self::PiUpper => "icons/math/pi-upper.svg",
            Self::Plus => "icons/editor/plus.svg",
            Self::PlusSquare => "icons/ui/plus-square.svg",
            ...
            Self::Sigma => "icons/math/sigma.svg",
            Self::SortAscending => "icons/sort-ascending.svg",
            Self::SortDescending => "icons/sort-descending.svg",
            Self::Sqrt => "icons/math/sqrt.svg",
            Self::SquareTerminal => "icons/square-terminal.svg",
            Self::Star => "icons/star.svg",
            Self::StarOff => "icons/star-off.svg",
            Self::Subscript => "icons/math/subscript.svg",
            Self::Sun => "icons/sun.svg",
            Self::Superscript => "icons/math/superscript.svg",
            Self::Theta => "icons/math/theta.svg",
            Self::ThetaUpper => "icons/math/theta-upper.svg",
            Self::ThumbsDown => "icons/thumbs-down.svg",
            Self::ThumbsUp => "icons/thumbs-up.svg",
            Self::TriangleAlert => "icons/triangle-alert.svg",
            Self::Undo => "icons/editor/undo.svg",
            Self::Undo2 => "icons/undo-2.svg",
            Self::User => "icons/user.svg",
            Self::Variable => "icons/math/variable.svg",
            Self::WindowClose => "icons/window/window-close.svg",
            Self::WindowMaximize => "icons/window/window-maximize.svg",
            Self::WindowMinimize => "icons/window/window-minimize.svg",
            Self::WindowRestore => "icons/window/window-restore.svg",
        }
        .into()
    }
}
