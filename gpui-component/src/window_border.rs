...
fn resize_edge(
    ...
    let can_right = !tiling.right;

    let edge = if can_top && can_left && pos.y < hit_size && pos.x < hit_size {
        ResizeEdge::TopLeft
    } else if can_top && can_right && pos.y < hit_size && pos.x > size.width - hit_size {
        ResizeEdge::TopRight
    } else if can_top && pos.y < hit_size {
        ResizeEdge::Top
        ...
        && pos.x > size.width - hit_size
    {
        ...
        ResizeEdge::Bottom
    } else if can_left && pos.x < hit_size {
        ResizeEdge::Left
    } else if can_right && pos.x > size.width - hit_size {
        ResizeEdge::Right
    } else {
        return None;
    };
